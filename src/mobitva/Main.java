...
public class Main {
    ...
    public static int[] heroesHealth = {260, 270, 200, 240, 260, 250, 250, 500};
    public static int[] heroesDamage = {20, 15, 10, 0, 20, 8, 0, 5};

    public static String[] heroesAttackType = {"Physical", "Magical", "Kinetic", "Medik", "Golem", "Thor", "Lucky", "Berserk"};
        ...
        if (heroesHealth[4] > 0 && bossHealth > 0) {
            switch (randoms) {
                case 1:
                    ...
                    System.out.println("Крит от Берсерка");
                    System.out.println("Удвоенный урон от защиты");
                    break;
                case 2:
                    bossDamage = 50;
                    break;
